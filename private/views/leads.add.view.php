...
<?php $this->view('includes/nav')?>
 ...
 <form method="post">
		...
		<div class="row">
				...
				<h3 class="text-center"><a href="<?=ROOT?>/leads">Leads</a> &nbsp<i class="fa fa-chevron-right"></i>Create </h3>
				<br>
				...
				<table class="table">
							...
							<tr>
								...
								<td><label>Title</label>
									<input class="form-control form-control-lg" value="<?=get_var('lead')?>" type="text" name="lead" placeholder="" aria-label=".form-control-lg example">
