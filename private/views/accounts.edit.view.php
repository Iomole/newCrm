		...
		<div class="row">
				...
				<div class="text-center">
					...
					<a href="<?=ROOT?>/accounts">
						<button type="button" class="btn-sm btn btn-danger p-2">Cancel</button>
					</a>
				</div>
			...
			<div class="col-sm-8 col-md-9 bg-light p-4">
				...
				<table class="table">
							...
							<tr>
								...
								<td><label>Name*</label>
									<input class="form-control form-control-lg" value="<?=get_var('account',$row[0]->account)?>" type="text" name="account" placeholder="*Name" aria-label=".form-control-lg example">
									
								</td>

								<td><label>website</label>
									<input class="form-control form-control-lg" value="<?=get_var('website',$row[0]->website)?>" type="text" name="website"
							</tr>
							...
							<tr>
								...
								<td><label>Email</label>
									<input class="form-control form-control-lg" value="<?=get_var('email',$row[0]->email)?>" type="text" name="email" placeholder="@" aria-label=".form-control-lg example">
								...
								<td><label>Phone</label>
									...
									<input class="form-control form-control-lg" value="<?=get_var('phone',$row[0]->phone)?>" type="text" name="phone" placeholder="" aria-label=".form-control-md example">
								</td>
							</tr>
							...
							<tr>
								...
								<td><label>Billing Address</label>
									...
									<input class="form-control form-control-lg" value="<?=get_var('b_address',$row[0]->b_address)?>" type="text" name="b_address" placeholder="Street" aria-label=".form-control-lg example">
									<div class="input-group">
									<input class="form-control form-control-lg" value="<?=get_var('b_city',$row[0]->b_city)?>" type="text" name="b_city" placeholder="city" aria-label=".form-control-lg example">
									<input class="form-control form-control-lg" value="<?=get_var('b_state',$row[0]->b_state)?>" type="text" name="b_state" placeholder="state" aria-label=".form-control-lg example">
									<input class="form-control form-control-lg" value="<?=get_var('b_pcode',$row[0]->b_pcode)?>" type="text" name="b_pcode" placeholder="postal code" aria-label=".form-control-lg example">
								</div>
									<input class="form-control form-control-lg" value="<?=get_var('b_country',$row[0]->b_country)?>" type="text" name="b_country" placeholder="country" aria-label=".form-control-lg example">
									
								</td>

								<td><label>Shipping Address</label>


									<input class="form-control form-control-lg"  value="<?=get_var('s_address',$row[0]->s_address)?>"type="text" name="s_address" placeholder="Street" aria-label=".form-control-md example">
									<div class="input-group">
									<input class="form-control form-control-lg" value="<?=get_var('s_city',$row[0]->s_city)?>" type="text" name="s_city" placeholder="city" aria-label=".form-control-lg example">
									<input class="form-control form-control-lg" value="<?=get_var('s_state',$row[0]->s_state)?>"type="text" name="s_atate" placeholder="state" aria-label=".form-control-lg example">
									<input class="form-control form-control-lg" value="<?=get_var('s_pcode',$row[0]->s_pcode)?>"type="text" name="s_pcode" placeholder="postal code" aria-label=".form-control-lg example">
								</div>
									<input class="form-control form-control-lg" value="<?=get_var('s_country',$row[0]->s_country)?>"type="text" name="s_country" placeholder="country" aria-label=".form-control-lg example">
								</td>
							</tr>
							...
							<tr>
								...
								<td><label>Type</label>
									<select class="form-select form-select-lg" aria-label="Default select example" name="type">
	 										 <option <?=get_select('type',$row[0]->type)?> value="<?=$row[0]->type?>"><?=ucwords($row[0]->type)?></option>
	 										 <option <?=get_select('type','Customer')?>  value="Customer">Customer</option>
	 										 <option <?=get_select('type','Investor')?>  value="Investor">Investor</option>
	 										 <option <?=get_select('type','Partner')?>  value="Partner">Partner</option>
	 										 <option <?=get_select('type','reseller')?>  value="Reseller">Reseller</option>
								    </select>
								...
								<td><label>Industry</label>
									<select class="form-select form-select-lg" aria-label="Default select example" name="industry">
	 										 <option <?=get_select('industry',$row[0]->industry)?>  value="<?=$row[0]->industry?>"><?=ucwords($row[0]->industry)?></option>
   						 ...
   						 <select class="form-select form-select-lg" aria-label="Default select example" name="assigned_userId">
	 										 <option <?=get_select('assigned_userId',$row[0]->assigned_userId)?>   value="<?=$row[0]->assigned_userId ?>"><?=$row[0]->userd->firstname ?> <?=$row[0]->userd->lastname ?></option>
	 										 
	 										 <?php foreach($rows2 as $output):?>
											 <option <?=get_select('assigned_userId',$output->user_id)?> value="<?=$output->user_id?>"><?=$output->firstname ?>  <?=$output->lastname ?></option>
											 <?php endforeach;?>
								    </select>
								...
								<td><div class="cell form-group col-sm-6 col-md-12" data-name="teams">
        							...
        							<div class="link-container list-group"></div>
										...
										<div class="input-group add-team form-select-sm" >
   										 <select class="form-select form-select-lg" aria-label="Default select example" name="team">
	 										 <option <?=get_select('team',$row[0]->team)?> value="<?=$row[0]->team?>"><?=ucwords($row[0]->team)?></option>
						...
						<div class="cell col-sm-12 form-group" data-name="description">
								...
								<textarea class="main-element form-control auto-height" value="<?=get_var('description',$row[0]->description)?> data-name="description" rows="2" autocomplete="espo-description" name="description"></textarea>
							  </div>
...
<?php else: ?>
			...
			<div style="text-align: center;">
				<h3>That account was not found!</h3>
