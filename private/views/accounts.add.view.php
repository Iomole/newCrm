...
<?php $this->view('includes/nav')?>
 ...
 <form method="post">
		...
		<div class="row">
				...
				<h3 class="text-center"><a href="<?=ROOT?>/accounts">Accounts</a> > Add new</h3>
				<br>
			...
			<div class="col-sm-8 col-md-9 bg-light p-4">
				...
				<table class="table">
							...
							<tr>
								...
								<td><label>Name*</label>
									<input class="form-control form-control-lg" value="<?=get_var('account')?>" type="text" name="account" placeholder="*Name" aria-label=".form-control-lg example">
									
								</td>

								<td><label>website</label>
									<input class="form-control form-control-lg" value="<?=get_var('website')?>" type="text" name="website"
							</tr>
							...
							<tr>
								...
								<td><label>Phone</label>
									...
									<input class="form-control form-control-lg" value="<?=get_var('phone')?>" type="text" name="phone" placeholder="" aria-label=".form-control-md example">
								</td>
							</tr>
							...
							<tr>
								...
								<td><label>Shipping Address</label>
									...
									<input class="form-control form-control-lg"  value="<?=get_var('s_address')?>"type="text" name="s_address" placeholder="Street" aria-label=".form-control-md example">
									<div class="input-group">
									<input class="form-control form-control-lg" value="<?=get_var('s_city')?>" type="text" name="s_city" placeholder="city" aria-label=".form-control-lg example">
									<input class="form-control form-control-lg" value="<?=get_var('s_state')?>"type="text" name="s_atate" placeholder="state" aria-label=".form-control-lg example">
									<input class="form-control form-control-lg" value="<?=get_var('s_pcode')?>"type="text" name="s_pcode" placeholder="postal code" aria-label=".form-control-lg example">
								    </div>
									<input class="form-control form-control-lg" value="<?=get_var('s_country')?>"type="text" name="s_country" placeholder="country" aria-label=".form-control-lg example">
								</td>
							</tr>
							...
							<tr>
								...
								<td><label>Type</label>
									<select class="form-select form-select-lg" aria-label="Default select example" name="type">
	 										 <option <?=get_select('type','')?> selected></option>
