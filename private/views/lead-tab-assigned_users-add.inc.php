<form method="post" class="form mx-auto" style="width:100%;max-width: 400px;">
	...
	<input value="<?=get_var('name')?>" autofocus class="form-control" type="text" name="name" placeholder="user Name">
	<br>
	<a href="<?=ROOT?>/single_lead/<?=$row->lead_id?>?tab=assigned_users">
